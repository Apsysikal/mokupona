...
export default function Index() {
  return (
    <div>
      <div className="h-[calc(100vh-3.5rem)] p-2 flex flex-col gap-2 relative text-white">
        ...
        <div className="flex flex-col grow place-content-center gap-4 max-w-3xl mx-auto">
          <span className="text-xl font-light">Hello, we are</span>
        ...
        <div className="flex flex-col w-full gap-2 max-w-3xl mx-auto">
          <Link
            to="/dinners"
